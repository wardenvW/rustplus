...
from ..gateway.rustplus_proto import AppMarker, AppMarkerSellOrder, Vector4
...
class RustSellOrder(Serializable):
    ...
    def __str__(self) -> str:
        return "RustSellOrder[item_id={}, quantity={}, currency_id={}, cost_per_item={}, amount_in_stock={}, item_is_blueprint={}, currency_is_blueprint={}]".format(
            self._item_id,
            self._quantity,
            self._currency_id,
            self._cost_per_item,
            self._amount_in_stock,
