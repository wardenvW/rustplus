...
from rustWplus.identification.handler_list import EntityHandlerList
from ..gateway.rustplus_proto import AppEntityPayloadItem, AppEntityChanged
...
class EntityEventPayload:
    ...
    def __init__(self, entity_changed: AppEntityChanged) -> None:
        self._entity_id = entity_changed.entity_id
        self._value = entity_changed.payload.value
        self._capacity = entity_changed.payload.capacity
        self._has_protection = entity_changed.payload.has_protection
        self._protection_expiry = entity_changed.payload.protection_expiry
